...
namespace IntexFinal.Models
{
    public interface ICrashRepository
    {
        ...
        List<crash_data> GetFiltered(string? city, string? county_name, int? route, double? milepoint, string? main_road_name, int? crash_severity_id, bool? work_zone_related, bool? pedestrian_involved, bool? bicyclist_involved, bool? motorcycle_involved, bool? improper_restraint,
